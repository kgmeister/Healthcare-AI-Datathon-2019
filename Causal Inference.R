...
setwd("C:/Users/adria/OneDrive/Desktop/NUS datathon")

df_1 = read.csv("C:/Users/adria/OneDrive/Desktop/NUS datathon/cov data/metric_final_updated.csv")
# df_1 = read.csv("C:/Users/adria/OneDrive/Desktop/NUS datathon/cov data/param_y_v2.csv")
df_2 = read.csv("C:/Users/adria/OneDrive/Desktop/NUS datathon/cov data/pat_adm_no.csv")
df_3 = read.csv("cov data/age.csv")
df_4 = read.csv("cov data/emerg_prop.csv")
df_5 = read.csv("cov data/cci_score_weekly.csv")
#df_6 = read.csv("cov data/week_count.csv")
df_7 = read.csv("cov data/dis_married.csv")
df_8 = read.csv("cov data/adm_married.csv")
df9 = read.csv("cov data/death_rate2016.csv")
